...
public class ChooseRoleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardAdmin.setOnClickListener(view -> navigateToAdminLogin("admin"));
    }
    ...
    private void navigateToAdminLogin(String role) {
        Intent intent = new Intent(ChooseRoleActivity.this, AdminLoginActivity.class);
        intent.putExtra("ROLE", role);
        startActivity(intent);
    }
}
