...
public class NotificationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof ItemViewHolder) {
            ...
            // Update the background based on read status
            if (notification.isRead()) {
                itemViewHolder.itemView.setBackgroundColor(ContextCompat.getColor(context, R.color.read_notification_bg));
            } else {
                itemViewHolder.itemView.setBackgroundColor(ContextCompat.getColor(context, R.color.unread_notification_bg));
            }
