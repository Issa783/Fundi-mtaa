                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            ...
                            // Check if 'isAssigned' is a Boolean
                            Boolean isAssignedBoolean = null;
                            try {
                                isAssignedBoolean = document.getBoolean("isAssigned");
                            } catch (Exception e) {
                                // Handle the case where 'isAssigned' is not a Boolean
                                e.printStackTrace();
                            }
    ...
    private class JobAdapter extends RecyclerView.Adapter<JobViewHolder> {
        ...
        public void onBindViewHolder(JobViewHolder holder, int position) {
            ...
            holder.buttonDelete.setOnClickListener(v -> {
                ...
                new AlertDialog.Builder(ViewJobsActivity.this)
                        .setTitle("Delete Job")
